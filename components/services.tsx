            ...
            <li className="services-list__item is-active">
              ...
              <div className="services-list__item-body">
                <p>
                  ...
                  fringilla pede sit amet augue. Praesent blandit laoreet nibh.
            ...
            <li className="services-list__item">
              ...
              <div className="services-list__item-body">
                <p>
                  ...
                  Fusce fermentum. Curabitur turpis. Nunc egestas, augue at
                  pellentesque laoreet, felis eros vehicula leo, at malesuada
                  velit leo quis pede. In consectetuer turpis ut velit.
                  Curabitur at lacus.
                </p>
              </div>
            </li>
            ...
            <li className="services-list__item">
              ...
              <div className="services-list__item-body">
                <p>
                  ...
                  vitae tortor. Ut tincidunt tincidunt erat. Praesent nonummy mi
                  in odio. Praesent ut ligula non mi varius sagittis. Curabitur
                  turpis. Nunc egestas, augue at pellentesque laoreet, felis
                  eros vehicula leo, at malesuada velit leo quis pede.
                </p>
              </div>
            </li>
            {/* <!-- services-list__item --> */}
            <li className="services-list__item">
              ...
              <div className="services-list__item-body">
                <p>
                  ...
                  ornare lobortis. Morbi nec metus. Aenean vulputate eleifend
                  tellus. Nullam vel sem. Nam ipsum risus, rutrum vitae,
                  vestibulum eu, molestie vel, lacus. Phasellus ullamcorper
                  ipsum rutrum nunc. Cras dapibus. Praesent egestas neque eu
                  enim.
                </p>
              </div>
            </li>
