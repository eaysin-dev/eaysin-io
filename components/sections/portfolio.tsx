...
export type Portfolio = {
  ...
  externalResource?: { id: string; [key: string]: string }[];
};
            ...
            <Card className="border border-muted p-1" key={recentWork?.id}>
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2">
                  {recentWork.technologies.length > 0 ? (
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    {Object.keys(recentWork?.clientInformation || {}).map(
                      (key) => (
                        <div key={key}>
              ...
              <CardFooter className="flex flex-col justify-end items-start gap-3">
                {recentWork?.isConfidential && (
                  <p className="text-sm text-muted-foreground">
                    ...
                    {recentWork?.clientInformation?.company}.
                  </p>
                )}
                    ...
                    <DialogContent className="max-w-6xl h-[80vh] overflow-y-scroll">
                      <div>
                        ...
                        <blockquote className="mt-6 border-l-2 pl-6 italic">
                          &quot;After all,&quot; he said, &quot;everyone enjoys
                          a good joke, so it&apos;s only fair that they should
                        ...
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                          ...
                          of the night and leaving jokes all over the place:
                          under the king&apos;s pillow, in his soup, even in the
                          royal toilet. The king was furious, but he
                        ...
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                          ...
                          laughter, started to tell jokes and puns again, and
                        ...
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                          ...
                          tax. Jokester was declared a hero, and the kingdom
                          lived happily ever after.
                        </p>
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                          The moral of the story is: never underestimate the
                          power of a good laugh and always be careful of bad
                          ideas.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="mt-2 flex flex-wrap items-center gap-2">
                          {recentWork?.externalResource?.map((resource) => (
                            <li key={resource?.id}>
                              <a
                                href={resource?.value}
                                target="_blank"
